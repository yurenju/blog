...
5. **IMPORTANT - Back-translation**: After completing the Japanese translation, translate the Japanese version BACK to Chinese. This is NOT the original Chinese text - you must translate from Japanese to Chinese to show what the Japanese version actually conveys. This helps verify the translation quality and context coherence.
...
5. **IMPORTANT - Back-translation**: After completing the English translation, translate the English version BACK to Chinese. This is NOT the original Chinese text - you must translate from English to Chinese to show what the English version actually conveys. This helps verify the translation quality and context coherence.
6. Combine into the output format (see below)
...
- **CRITICAL**: The back-translation is NOT a copy of the original Chinese text. You must translate FROM the target language (Japanese/English) BACK to Chinese
- **Purpose**: The back-translation shows what the translated version actually conveys in the target language, helping verify context coherence and cultural adaptation rather than literal accuracy
- **Why**: Since translation focuses on context coherence (especially for life category), the back-translation may differ from the original, which is expected and desired
...
### Back-translation Example Flow
1. Original Chinese: "這是一個測試"
2. Translate to Japanese: "これはテストです"
3. Back-translate to Chinese: "這是測試" (translated FROM the Japanese, may differ slightly)
4. ❌ WRONG: Copy original "這是一個測試" as back-translation
5. ✅ CORRECT: Translate the Japanese back to get "這是測試"
...
4. **Generate Chinese back-translations by translating FROM Japanese/English BACK to Chinese** (NOT copying the original)
5. Save both translated files to the correct locations
6. Inform the user of completion and file locations

**CRITICAL REMINDER**: The back-translation MUST be generated by translating the target language version back to Chinese. Do NOT copy or reuse the original Chinese text.
